export const testimonials = [
  {
    ...
    comment: "Great Work",
    description: `شكرا عمر لأنك غيرتني وأكيد غيرت ناس كثير استمر نحن نشجعك وندعمك وربي يوفقك`,
  },
  {
    id: 1,
    ...
    comment: "Great Work",
    description: `أنا واجد فكري تغير واااجججدد وبديت اخطط لبزنسات وكذا اطور البزنس مالي بعد م تركته وتكاسلت عنه وأصبت بالاحباط`,
  },
  {
    id: 2,
    ...
    comment: "Great Work",
    description: `أول شي احمد ربي سبحان الله والف الحمد لله اني عرفت قناتك وحسابك صدفة ودخلت الكورس`,
  },
  {
    id: 3,
    ...
    position: "Web Designer",
    comment: "Great Work",
    description: `قسم بالله ما كذبت بحرف واحد لما قلت عنك قدوة`,
  },
];
