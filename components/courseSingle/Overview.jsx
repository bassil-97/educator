...
export default function Overview() {
  ...
  return (
    <div id="overview" className="pt-60 lg:pt-40 to-over">
      <h4 className="text-18 fw-500">تفاصيل عن الكورس</h4>
      ...
      >
        ...
        >
          ...
          المعلومات الي داخل الكورس لو تعلمتها وطبقها فأنت حرفيًا مسكت طريق الثراء، يبقى عليك الاستمرار فقط !
            <br />
            <br />
            ايش هو كورس حرر عقلك؟ دروس مسجلة تتابعها في أي وقت، مرحلة كاملة من أسرار عقلية الثري بالاضافة الى شرح كامل لمشاريع تقدر تبدأ فيها. إذا ما استفدت شي؟ مبلغ الاشتراك يرجعلك
            <br />
          </p>
        </div>
      ...
      <div className="mt-60">
        <h4 className="text-20 mb-30">كيف رح تستفيد من الكورس</h4>
