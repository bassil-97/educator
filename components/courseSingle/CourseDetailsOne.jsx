...
const menuItems = [
  { id: 1, href: "#overview", text: "نظرة عامة", isActive: true },
  { id: 2, href: "#course-content", text: "محتويات الكورس", isActive: false },
  { id: 3, href: "#instructors", text: "المدرب", isActive: false },
  { id: 4, href: "#reviews", text: "التقييمات", isActive: false },
];
          ...
          <div className="page-header__content pt-90 pb-90">
            <div className="row y-gap-30">
              <div className="col-xl-7 col-lg-8">
                ...
                <div>
                  <h1 className="text-30 lh-14 lg:pr-0">
                    {pageItem.title}
                  </h1>
                </div>

                <p className="col-xl-9 mt-20">
                الكورس الي راح يقودك للحرية المالية
                </p>
                ...
                <div className="d-flex x-gap-30 y-gap-10 items-center flex-wrap pt-20">
                  <div className="d-flex items-center">
                    ...
                    <div className="d-flex x-gap-5 items-center ml-10">
                  ...
                  <div className="d-flex items-center text-light-1">
                    ...
                    <div className="text-14 mr-8">
                      {pageItem.studentsEnrolled} انضموا الى هذا الكورس
                    </div>
                  </div>

                  <div className="d-flex items-center text-light-1">
                    <div className="icon icon-wall-clock text-13"></div>
                    <div className="text-14 mr-8">آخر تحديث 08/2023</div>
                  </div>
                </div>
                ...
                <div className="d-flex items-center pt-20">
                  ...
                  ></div>
                  <div className="text-14 lh-1 mr-10">
                    {pageItem.authorName}
                  </div>
                </div>
              </div>
