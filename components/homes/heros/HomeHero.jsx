...
import move_img_1 from "../../../public/assets/img/masthead/move_img_1.jpg";
import move_img_2 from "../../../public/assets/img/masthead/move_img_2.jpg";
import move_img_3 from "../../../public/assets/img/masthead/omar-1.jpg";

const masthead_info = [
  {
    id: 1,
    icon: masthead_icon_1,
    text: "أكثر من 100 طالب",
  },
  {
    id: 2,
    icon: masthead_icon_2,
    text: "دروس مسجلة تتابعها في أي وقت",
  },
  {
    id: 3,
    icon: masthead_icon_3,
    text: "تعلم كل شيء أونلاين",
  },
];

const hero_content = {
  title: "ابدأ تأسيس مشروعك أونلاين من خلال كورس",
  text_underline: "حرر عقلك",
  info_hero: (
    <>
     انضم إلى أكثر من 250 مشترك حول الوطن العربي!
    </>
  ),
  starts: [
                ...
                <div className="masthead-image__el1">
                  ...
                  >
                    ...
                    <div className="mr-20">
                      ...
                      <div className="mt-3">سنوات خبرة</div>
                    </div>
                  </div>
                </div>
