...
export default function CourseListOne() {
  ...
  const [currentSortingOption, setCurrentSortingOption] = useState("افتراضي");
  ...
  const fetchUserCourses = async () => {
    try {
      let responseData = await sendRequest(`http://api.faconsulting.me/api/users/get-user-courses/${userId}`);
  ...
  useEffect(() => {
    if (currentSortingOption == "افتراضي") {
      setSortedFilteredData(filteredData);
    } else if (currentSortingOption == "التقييمات (asc)") {
      setSortedFilteredData(
        [...filteredData].sort((a, b) => a.rating - b.rating),
      );
    } else if (currentSortingOption == "التقييمات (dsc)") {
      setSortedFilteredData(
        [...filteredData].sort((a, b) => b.rating - a.rating),
      );
    } else if (currentSortingOption == "السعر (asc)") {
      setSortedFilteredData(
        [...filteredData].sort((a, b) => a.discountedPrice - b.discountedPrice),
      );
    } else if (currentSortingOption == "السعر (dsc)") {
      setSortedFilteredData(
        [...filteredData].sort((a, b) => b.discountedPrice - a.discountedPrice),
      );
    } else if (currentSortingOption == "المدة (asc)") {
      setSortedFilteredData(
        [...filteredData].sort((a, b) => a.duration - b.duration),
      );
    } else if (currentSortingOption == "المدة (dsc)") {
      setSortedFilteredData(
          ...
          <div className="page-header__content">
            <div className="row">
              <div className="col-auto">
                <div>
                  <h1 className="page-header__title">قائمة الكورسات</h1>
                </div>
                        ...
                        >
                          <div className="accordion__content__inner">
                            <div className="sidebar-checkbox">
                              ...
                              >
                                <div className="form-checkbox ml-5">
                                  <input
                                    type="checkbox"
                                    checked={
                              ...
                              {categories.map((elm, i) => (
                                ...
                                >
                                  ...
                                  <div className="sidebar-checkbox__title ml-5">
                                    {elm.title}
                                  </div>
                      ...
                      <div className="row x-gap-20 y-gap-20">
                        <div className="col-auto">
                          <div className="d-flex items-center">
                            <div className="text-14 lh-12 fw-500 text-dark-1 ml-20">
                              ترتيب حسب:
                            </div>
                            ...
                            >
                              ...
                              >
                                ...
                                <i className="icon text-9 mr-40 icon-chevron-down"></i>
                              </div>
                      ...
                      <div className="coursesCard -type-1 ">
                        ...
                        <div className="h-100 pt-15">
                          <div className="d-flex items-center">
                            ...
                            <div className="text-13 lh-1 mr-10">
                              ({elm.ratingCount})
                            </div>
                          </div>
                          ...
                          <div className="coursesCard-footer">
                            <div className="coursesCard-footer__author">
                              <Image
                                ...
                                alt="image"
                              />
                              <div className="mr-5">{elm.authorName}</div>
                            </div>
